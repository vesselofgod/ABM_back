 ...
 *   post:
 *    summary: "유저 로그인 API"
 *    description: "로그인 시 사용자가 입력한 id와 password를 검증하고, 토큰을 생성한다."
 *    tags: [login]
 *    requestBody:
 *      description: " 유저의 id, password 입력값을 받아온다 "
 *      required: true
 *      content:
 *        application/json:
 *          schema:
 ...
 *    responses:
 *      "200":
 *        description: 로그인과 토큰 생성이 성공적으로 완료되었을때
 *        content:
 *          application/json:
 *            schema:
 *              type: object
 ...
 *                token:
 *                  type: string
 *                  example: eyJhbGciOiJIUBa1NiJ9.NjNiY2QwYmUwNDBlMjQyNmE2ZjQ0YTc5.Mu7K58qtGAQq0r3aAotTmmMba65uDoRRpg3nVqe1qVw
 *                setProfile:
 *                  type: boolean
 *                  example: true/false
 *      "400":
 *        description: 로그인 시에 id 혹은 password가 틀렸을 경우
 *        content:
 *          application/json:
 *            schema:
 *              type: object
 ...
 *                error:
 *                  type: object
 *                  example: { msg: "login failed"}
 *
 *      "401":
 *        description: 토큰 생성에 실패한 경우
 *        content:
 *          application/json:
 *            schema:
 *              type: object
